...
let kolDroidov = prompt ('Сколько дроидов хотите купить', 2);

let totalPrice = kolDroidov * pricePerDroid;
...
if (kolDroidov == null) {
    ...
    alert ("Вы купили ["+ kolDroidov +"] дроидов, на счету осталось ["+ (credits - totalPrice)+"] кредитов.")
};
